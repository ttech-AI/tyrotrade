...
- **Realised-expense belonging + sign model (calibrated to Power BI).** The per-project chain (`useProjectExpenseLines`) and the tenant rollup (`actualExpenseRollup`) share ONE model, verified to the cent against Power BI on PRJ000002000 (27.283,34), PRJ000002026 (1.691.033,74), and PRJ000002291 (787.618):
  - **Excluded codes** (`EXCLUDED_EXPENSE_IDS`, in BOTH files — keep in sync): taxes/treasury `730030 / 731016 / 790051 / 790052` **plus price-difference codes `710017 / 710041` and `712207`**. Power BI's realised report shows none of these. (Earlier belief that PBI counts 710041/710017 was wrong — the `PRICE_DIFF_EXPENSE_CODE` positive-render hack it implied was never live code and is gone; just exclude them.)
