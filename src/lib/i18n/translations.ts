...
const tr: StringMap = {
  ...
  "title.dataManagement": "Veri Yönetimi",
...
const en: StringMap = {
  ...
  "nav.dashboard": "Management Panel",
  "nav.projects": "Voyage Tracking",
  "nav.tradeCost": "Trade Cost",
  "nav.priceTracking": "Price Tracking",
