...
/** localStorage key prefix. Exported so the hooks that listen for cross-tab
 *  storage events match the same namespace instead of hardcoding it. */
export const KEY_PREFIX = "tyrotrade:dv:";
...
export const CACHE_UPDATED_EVENT = "tyrotrade:cache-updated";
