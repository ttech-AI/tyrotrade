...
import { Layers, ChevronLeft } from "@/freight/icons";
import { useProjects } from "@/freight/hooks/useProjects";
import { ProjectList } from "@/freight/components/projects/ProjectList";
import { ProjectsEmptyState } from "@/freight/components/projects/ProjectsEmptyState";
import { RouteMap } from "@/freight/components/map/RouteMap";
import { ProjectOverviewCard } from "@/freight/components/details/ProjectOverviewCard";
import { CommoditySalesCard } from "@/freight/components/details/CommoditySalesCard";
import { ExpectedRealizedExpenseCard } from "@/freight/components/details/ExpectedRealizedExpenseCard";
import { BudgetSalesCard } from "@/freight/components/details/BudgetSalesCard";
import { BudgetPLCard } from "@/freight/components/details/BudgetPLCard";
import { ScrollArea } from "@/components/ui/scroll-area";
import { Button } from "@/components/ui/button";
import { useIsMobile } from "@/freight/hooks/useMediaQuery";
import { AdvancedFilter } from "@/freight/components/filters/AdvancedFilter";
import { MultiSelectCombobox } from "@/freight/components/ui/multi-select-combobox";
...
export function ProjectsPage() {
  ...
  // No projects cached yet — point the user at Data Management. Deliberately
  // placed AFTER every hook above: `isEmpty` flips to false as soon as the
  // async cache hydration lands, and an early return before the hooks would
