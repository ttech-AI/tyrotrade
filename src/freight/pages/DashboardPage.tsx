...
import { PeriodPerformanceTile } from "@/freight/components/dashboard/tiles/PeriodPerformanceTile";
import { MonthlyPLChart } from "@/freight/components/dashboard/MonthlyPLChart";
import { AdvancedFilter } from "@/freight/components/filters/AdvancedFilter";
import {
  KpiDetailDrawer,
  type KpiId,
} from "@/freight/components/dashboard/KpiDetailDrawer";
import { KpiDrawerToolbar } from "@/freight/components/dashboard/KpiDrawerToolbar";
import {
  ExpenseBreakdown,
  PipelineBreakdown,
  CurrencyBreakdown,
  ...
  QuantityBreakdown,
  filterProject,
} from "@/freight/components/dashboard/kpiBreakdowns";
import {
  TONE_FORECAST,
  TONE_PL,
  TONE_CARGO,
  ...
  TONE_COUNTERPARTY,
  type IconBadgeTone,
} from "@/freight/components/details/AccentIconBadge";
...
import { useProjects } from "@/freight/hooks/useProjects";
import { ProjectsEmptyState } from "@/freight/components/projects/ProjectsEmptyState";
import {
  aggregatePipelineBuckets,
} from "@/freight/lib/selectors/aggregate";
import { selectStage } from "@/freight/lib/selectors/project";
import { aggregateMonthlyPL, aggregateRealizedPL } from "@/freight/lib/selectors/monthlyPL";
import { useActualExpenseRollup } from "@/freight/hooks/useActualExpenseRollup";
import { useRealizedByMonth } from "@/freight/hooks/useRealizedByMonth";
import { useSegmentBudgetMap } from "@/freight/hooks/useSegmentBudgetMap";
import { RealizedPLTable } from "@/freight/components/dashboard/RealizedPLTable";
import { RealizedPLDetailSheet } from "@/freight/components/dashboard/RealizedPLDetailSheet";
import {
  PowerBIPLDetailSheet,
  type PowerBIPLDetail,
} from "@/freight/components/dashboard/PowerBIPLDetailSheet";
import { PendingPaymentsCard } from "@/freight/components/overview/PendingPaymentsCard";
import { usePendingPayments } from "@/freight/hooks/usePendingPayments";
import {
...
import {
  ...
  getPowerBISegments,
  hasPowerBIPL,
} from "@/freight/lib/selectors/powerbiPLTable";
    ...
    <Tooltip>
      ...
      <TooltipContent
        ...
        className={cn(
          ...
          "bg-[color-mix(in_oklab,var(--popover)_97%,transparent)] backdrop-blur-2xl backdrop-saturate-150",
      ...
      >
        <div className="px-3 py-2 border-b border-border/40 flex items-center gap-2">
          ...
          />
          <span className="text-[11px] font-bold uppercase tracking-wider text-popover-foreground">
          ...
          {visible.map((p) => (
            ...
            >
              <div className="flex items-baseline gap-1.5 min-w-0">
                ...
                <span className="text-[11.5px] font-semibold text-popover-foreground truncate">
                  {p.projectName}
                </span>
              </div>
              {p.segment && (
