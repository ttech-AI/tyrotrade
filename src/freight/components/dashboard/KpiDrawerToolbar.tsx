      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative flex-1 min-w-0">
          ...
          <input
            ...
            style={{
              // Same geometry as before; the specular lift is the shared
              // --spec-highlight (a white scar in dark mode otherwise) and the
              // drop shadow is mixed off --foreground so it inverts.
              boxShadow:
                "inset 0 1px 0 0 var(--spec-highlight), 0 2px 6px -3px color-mix(in oklab, var(--foreground) 16%, transparent)",
            }}
          />
          {query && (
            <button
