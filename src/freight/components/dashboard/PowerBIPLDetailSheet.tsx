...
import { AccentIconBadge, TONE_PL } from "@/freight/components/details/AccentIconBadge";
import { useLocale } from "@/hooks/useLocale";
import { formatNumber, formatCurrency } from "@/freight/lib/format";
import type { PowerBIPLSegmentRow } from "@/freight/data/powerbiPL";

const EST = "var(--series-projected)"; // projected / tahmini (brand accent)
const REAL = "var(--series-realized)"; // realized / gerçekleşen (P&L green)
            ...
            <table className="w-full border-collapse text-[12px]">
              <thead>
                <tr className="text-[10px] uppercase tracking-wider">
                  ...
                  <th className="px-2 py-2 text-right font-bold text-muted-foreground whitespace-nowrap">
                    {t("dash.rpl.budget")}
                  </th>
                </tr>
              </thead>
              ...
              <tfoot>
                <tr className="border-t-2 border-border/70 font-bold text-foreground bg-foreground/[0.03]">
