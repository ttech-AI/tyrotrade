...
import { readCache } from "@/freight/lib/storage/entityCache";
import { describeProjectFilter } from "@/freight/lib/dataverse/refreshAll";
import { useLocale } from "@/hooks/useLocale";
import {
  RefreshErrorToast,
  RefreshLoadingToast,
  RefreshSuccessToast,
} from "@/freight/components/ui/refresh-toast";
 ...
 * the other talks to the AI). Brand palette accent gradient, animated
      ...
      <Tooltip>
        ...
        >
          ...
          >
            ...
            />
            <span className="text-[12px] font-bold uppercase tracking-wider text-popover-foreground">
            ...
            <div className="text-[11px] text-muted-foreground leading-relaxed">
              {(() => {
                ...
                return (
                  <>
                    {lead.slice(0, idx)}
                    <span className="font-semibold text-popover-foreground">{bold}</span>
