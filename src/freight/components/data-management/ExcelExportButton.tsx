...
import {
  exportSheetsToExcel,
  type ExcelSheetSpec,
} from "@/freight/lib/export/excelExport";
 ...
 *  Bu yüzden --brand-* değil --success: palet değişse de "başarı/indirme"
 *  anlamı korunur, dark mode'da ise token kendi karşılığına döner. */
...
const EXCEL_RING = "color-mix(in oklab, var(--success) 50%, transparent)";
...
export function ExcelExportButton({
  sheets,
  fileNameBase = "tyrotrade-veri-yonetimi",
  className,
}: {
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "rounded-full px-3.5 h-9 text-[13px] font-semibold text-[var(--success-foreground)]",
