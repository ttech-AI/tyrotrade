...
import { Layers } from "@/freight/icons";
    ...
    <div className="relative w-full min-w-0">
      ...
      <input
        ...
        className={cn(
          ...
          "bg-[color-mix(in_oklab,var(--card)_70%,transparent)] backdrop-blur-xl backdrop-saturate-150",
        ...
        style={{
          // Drop shadow inverts with the theme; the inset top line is the
          // glass specular edge, which index.css already themes.
          boxShadow:
  ...
  return (
    ...
    >
      ...
      {hasValue && (
        <span
          aria-hidden
          className="absolute -top-0.5 -right-0.5 size-2.5 rounded-full ring-2 ring-card"
