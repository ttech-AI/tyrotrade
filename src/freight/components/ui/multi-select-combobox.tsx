...
import { Check, ChevronsUpDown, X } from "@/freight/icons";
import {
  Command,
  CommandEmpty,
  CommandGroup,
        ...
        <PopoverTrigger asChild>
          <button
            ...
            className={cn(
              ...
              // Solid card background (was 80% translucent) so the
              ...
              "w-full border bg-card text-left text-[13.5px] leading-tight",
                ...
                {options.map((opt) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        {isSelected && (
                          <Check className="size-3.5 text-[var(--background)]" strokeWidth={3} />
                        )}
                      </span>
              ...
              {hasSelection && (
                <>
                  ...
                  <CommandGroup>
                    <CommandItem
                      onSelect={clearAll}
                      className="cursor-pointer text-destructive hover:text-destructive/80 px-2.5 py-2 text-[13px] gap-2"
                    >
                      <X className="size-4" />
