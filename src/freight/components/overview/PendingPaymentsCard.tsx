...
import { ArrowUpRight, ChevronDown } from "@/freight/icons";
...
import { type PendingPayments } from "@/freight/lib/selectors/overview";
  ...
  return (
    ...
    >
      ...
      {pending.count === 0 ? (
        ...
        <>
          {/* Summary strip — --destructive, not the brand: a stuck payment
              must read as "dikkat" in every palette. */}
          <div className="mx-3 rounded-xl bg-destructive/[0.07] border border-destructive/15 px-3.5 py-2.5 flex items-center gap-1.5">
            <span className="text-[22px] font-bold tabular-nums leading-none text-destructive">
              {pending.count}
            </span>
